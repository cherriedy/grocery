...
//        setContentView(R.layout.activity_add_product);
    ...
    protected void onResume() {
        ...
        ArrayAdapter<String> brandListAdapter = new ArrayAdapter<>(AddStaffActivity.this,R.layout.dropdown_item, mockBrandList) ;
        binding.acvBrand.setAdapter(brandListAdapter);

        String[] mockTypeList = resources.getStringArray(R.array.mockTypes);
        ArrayAdapter<String>  typeListAdapter = new ArrayAdapter<>(AddStaffActivity.this, R.layout.dropdown_item, mockTypeList);
